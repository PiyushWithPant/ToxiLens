...
# st.set_page_config(page_title="ToxiLens - Toxic Comment Classifier", page_icon="🤖")

# st.title("🔎 ToxiLens: Toxic Comment Detection")
# st.write("Enter any sentence below to check for toxicity levels.")

# # Text input box
# user_input = st.text_area("Type a comment here:", height=150)
...
#         st.subheader(f"🧩 Overall Classification: **{binary_label}**")
#         st.progress(float(binary_pred) if binary_pred > 0.5 else 1 - float(binary_pred))

#         # Display category-wise probabilities
